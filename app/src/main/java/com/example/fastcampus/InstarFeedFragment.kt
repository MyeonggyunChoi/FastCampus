...
class InstarFeedFragment :Fragment(){
    lateinit var mainActivity: InstarMainActivity
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.instar_feed_fragment, container, false)
    }

    override fun onAttach(context: Context) {
        super.onAttach(context)
        mainActivity = context as InstarMainActivity
    }
        ...
        retrofitService.getPosts().enqueue(object : Callback<ArrayList<PostItem>> {
            override fun onResponse(
                ...
                if (response.code() == 200) {
                    ...
                    val glide = Glide.with(this@InstarFeedFragment)
                    ...
                    mainActivity.findViewById<RecyclerView>(R.id.recyclerView).adapter = adapter
                }
            }
